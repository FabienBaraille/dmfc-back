 ...
 */
final class Version20231009085305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, year VARCHAR(60) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_F0E45BA9BB827337 (year), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, trigram VARCHAR(3) NOT NULL, name VARCHAR(60) NOT NULL, conference VARCHAR(10) NOT NULL, logo VARCHAR(180) DEFAULT NULL, nb_selected_home VARCHAR(3) NOT NULL, nb_selected_away SMALLINT DEFAULT NULL, ranking SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_C4E0A61FE9E2A637 (trigram), UNIQUE INDEX UNIQ_C4E0A61F5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, league_id INT DEFAULT NULL, username VARCHAR(60) NOT NULL, password VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', title VARCHAR(60) DEFAULT NULL, score SMALLINT DEFAULT NULL, old_position SMALLINT DEFAULT NULL, position SMALLINT DEFAULT NULL, season_played SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649296CD8AE (team_id), INDEX IDX_8D93D64958AFC4DE (league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
