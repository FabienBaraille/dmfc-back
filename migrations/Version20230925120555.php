 ...
 */
final class Version20230925120555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE news (id INT AUTO_INCREMENT NOT NULL, league_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_1DD3995058AFC4DE (league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, trigram VARCHAR(3) NOT NULL, name VARCHAR(60) NOT NULL, conference VARCHAR(10) NOT NULL, logo VARCHAR(180) DEFAULT NULL, nb_selected_home SMALLINT DEFAULT NULL, nb_selected_away SMALLINT DEFAULT NULL, ranking SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_C4E0A61FE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, league_id INT NOT NULL, username VARCHAR(60) NOT NULL, password VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, role LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', title VARCHAR(60) DEFAULT NULL, score SMALLINT DEFAULT NULL, old_position SMALLINT DEFAULT NULL, position SMALLINT DEFAULT NULL, season_played SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_8D93D649296CD8AE (team_id), INDEX IDX_8D93D64958AFC4DE (league_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
